...
public class CLIHelper {
	...
	public static void log(Exception e, String object, String method) {
		try {
			String fileName = Helper.dirFixer(CLIHelper.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()) + "AddressBook.log"; //Sets up the log file in the current directory of the program
			Date date = new Date();
