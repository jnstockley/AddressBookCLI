...
public class FrontendHelper {
	 ...
	 */
	public void log(Exception e, String object, String method) {
		try {
			String fileName = dirFixer(FrontendHelper.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()) + "AddressBook.log"; //Sets up the log file in the current directory of the program
			Date date = new Date();
	 ...
	 * @param method The method or function the error message came from
	 */
	public void log(String e, String object, String method) {
		try {
			String fileName = dirFixer(FrontendHelper.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()) + "AddressBook.log"; //Sets up the log file in the current directory of the program
			Date date = new Date();
			SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss"); //Sets up date and time of the error
	 ...
	 */
	public String dirFixer(String dir) {
	 ...
	 */
	public String dateFinder(BufferedReader reader) {
		try{
			String optionalDate = "";
	 ...
	 */
	public String timeFinder(BufferedReader reader) {
		try {
			String optionalTime = "";
